...
const updateBook = async () => {
  saving.value = true;
  try {
    // traz o updateBook do BookService, utiliza o modal configurado
...
<template>
  <h1 class="text-2xl font-bold p-7 bg-cyan-900 text-white">Editar Livro</h1>
