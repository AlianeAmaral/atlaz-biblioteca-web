...
<template>
  <h1 class="text-2xl font-bold p-7 bg-cyan-900 text-white">Detalhes do Aluno</h1>

  <div class="p-8 max-w-2xl text-black">

    <div v-if="loading">Carregando...</div>

    <div v-else-if="student" class="bg-white p-8 rounded-2xl shadow-lg flex flex-col gap-6">
      ...
      <div>
        ...
        <div v-if="student.enrollmentProofId" class="mt-2">
          <a :href="`http://localhost:8081/images/${student.enrollmentProofId}/download`"
            target="_blank"
      ...
      <div class="flex gap-4 pt-4">
        <button @click="router.push(`/students/${student.id}/edit`)"
