...
<template>
  ...
  <div class="p-8 max-w-2xl text-black">
    ...
    <div v-else-if="book" class="bg-white py-8 px-8 rounded-2xl shadow-lg flex flex-col gap-3">
      ...
      <div class="flex gap-4 pt-2">
        ...
        <button 
          ...
          class="flex-1 bg-cyan-900 hover:bg-cyan-700 text-white font-bold py-3 rounded-lg transition-colors">Editar
        </button>

        <button 
          @click="router.push('/books')" 
          class="flex-1 border border-gray-300 py-3 rounded-lg hover:bg-gray-100">Voltar
        </button>
